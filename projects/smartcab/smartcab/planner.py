...
class RoutePlanner(object):
    ...
    def next_waypoint(self):
        ...
        delta_b = (bounds[0] - location[0] + self.destination[0], bounds[1] - location[1] + self.destination[1])
        ...
        # Finally, check if destination is cardinally North or South of location
            ...
            if dy * heading[1] > 0:  # Heading the correct North or South direction
                ...
                if dx > 0: # Destination also to the East
                    ...
                    return 'right'
            elif dy * heading[0] > 0: # Heading East destination South; Heading West destination North
                return 'left'
            else:
                return 'right'